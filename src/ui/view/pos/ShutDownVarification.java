...
class ShutDownVarification extends javax.swing.JDialog {

// <editor-fold defaultstate="collapsed" desc="Variables">
    private static final Logger logger = Logger.getLogger(ShutDownVarification.class);
...
// <editor-fold defaultstate="collapsed" desc="Constructor">
    public ShutDownVarification(POSMDIInterface parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.parent = parent;
...
// <editor-fold defaultstate="collapsed" desc="Methods">
    ...
    private void confirmRefund() {
        ...
        try {
            if (isUserAuthenticated(txtUserName.getText().trim(), txtPassword.getPassword(), User.MANAGER)) {
                parent.setAuthenticatedToShutDown(true);
                this.dispose();
            } else {
...
// <editor-fold defaultstate="collapsed" desc="Netbeans generated Code">  
    ...
    private void initComponents() {
        ...
        setTitle("ShutDown Varification");
        setResizable(false);
