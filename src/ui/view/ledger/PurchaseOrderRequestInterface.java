 ...
 * @author Yasas
 */
public class PurchaseOrderRequestInterface extends javax.swing.JFrame {
     ...
     */
    public PurchaseOrderRequestInterface() {
        initComponents();
    ...
    private void initComponents() {
        ...
        itemDataTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Item Code", "Description", "Stock", "Quantity"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PurchaseOrderRequestInterface.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PurchaseOrderRequestInterface().setVisible(true);
            }
        });
    }
