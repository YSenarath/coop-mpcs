 ...
 * @author Yasas
 */
public class PurchaseOrderInterface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (itemDataTable.getColumnModel().getColumnCount() > 0) {
            ...
            itemDataTable.getColumnModel().getColumn(3).setPreferredWidth(150);
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {comboSupplier, txtF16aNumber});
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PurchaseOrderInterface().setVisible(true);
            }
        });
    }
