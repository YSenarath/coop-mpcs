...
import report.ledger.GRNListing;

public class GRNListingRequestInterfae extends javax.swing.JInternalFrame {
    //
    //
    // <editor-fold defaultstate="collapsed" desc="Variables">               

    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(GRNListingRequestInterfae.class);
    // </editor-fold>    
    //
    //
    // <editor-fold defaultstate="collapsed" desc="Interface"> 
    public GRNListingRequestInterfae() {
        initComponents();
        initInterface();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("GRN Listing Report");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new GRNListingRequestInterfae().setVisible(true);
        });
    }
    ...
    private void printDocument() {
        ArrayList<GoodRecieveNote> glist;
        try {
            ...
            if ("All".equals(supplierId)) {
                glist = GoodRecieveNoteController.getGrn("All", fromDate, toDate);
            } else {
                Supplier s = (Supplier) comboSupplier.getSelectedItem();
                glist = GoodRecieveNoteController.getGrn((s).getSupplerID(), fromDate, toDate);
