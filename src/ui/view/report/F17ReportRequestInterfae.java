 ...
 * @author Yasas
 */
public class F17ReportRequestInterfae extends javax.swing.JFrame {

    /**
     * Creates new form PettyCashCertificateRequestInterfae
     */
    public F17ReportRequestInterfae() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("F17 Report");

        comboReportType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Price Change Report", "Spoil/Waste Report" }));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new F17ReportRequestInterfae().setVisible(true);
            }
        });
    }
